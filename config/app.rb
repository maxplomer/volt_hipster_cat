...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-hipster-cat.com'
  config.app_name = 'Volt_hipster_cat'
  config.mailer.from = 'Volt_hipster_cat <no-reply@volt-hipster-cat.com>'
  ...
  #
  config.app_secret = 'b9yrw0T-KyKpcSJse9REBRdqZKKzEPI1MX-BYGEp5922IrEfRki2IFjndCyWbggsvMQ'
